...
while True:
    try:
        print("Введите токен для подключения к API Директа")
        user_token = str(input("Токен: "))
        ...
        for i in clients:
            ...
            report_name = str(i) + str(some_number)
            ...
            a = 1
            for x in range(true_row_number):
                a += 1
                clicks = ws['C' + str(a)]
        ...
        print('Ошибка, сообщите о ней разработчику, отправив E-mail со скриншотом на адрес aleksander.amelin@gmail.com :\n', traceback.format_exc())
        input("Нажмите Enter для выхода ")
        break    
